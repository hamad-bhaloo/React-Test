...
import { Package, BarChart3, Receipt, Calculator, CreditCard, Maximize2, Minimize2, ArrowLeft } from 'lucide-react';
        ...
        <Card className="max-w-md mx-auto">
          ...
          <CardContent className="text-center">
            <p className="text-muted-foreground mb-4">
              POS System is only available for paid subscribers.
            </p>
      ...
      <div className="min-h-screen bg-background flex items-center justify-center">
        <Card className="max-w-md mx-auto">
          <CardHeader className="text-center">
            ...
            <CardTitle>POS System Disabled</CardTitle>
          </CardHeader>
          <CardContent className="text-center">
            <p className="text-muted-foreground mb-4">
              Enable POS in Settings to access the POS system.
            </p>
            <div className="flex gap-2 justify-center">
              <Button variant="outline" onClick={() => navigate('/')}>
                <ArrowLeft className="h-4 w-4 mr-2" />
          ...
          <div className="flex justify-between items-center">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground">Complete point of sale and inventory management</p>
              </div>
            </div>
            <div>
